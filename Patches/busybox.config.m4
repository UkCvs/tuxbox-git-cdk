...
#
ifdef(`ide',
`option(`CONFIG_CHATTR', `y', `n')
option(`CONFIG_FSCK', `y', `n')
option(`CONFIG_LSATTR', `y', `n')',
...
option(`CONFIG_FEATURE_WGET_STATUSBAR', `n', `n')
option(`CONFIG_FEATURE_WGET_AUTHENTICATION', `n', `n')
