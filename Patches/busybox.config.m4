...
option(`CONFIG_DEBUG_PESSIMIZE', `n', `n')
...
option(`CONFIG_FEATURE_TAR_OLDGNU_COMPATIBILITY', `n', `n')
...
option(`CONFIG_FEATURE_DEVFS', `n', `n')
...
option(`CONFIG_FEATURE_FANCY_PING6', `n', `n')
...
option(`CONFIG_FEATURE_TRACEROUTE_USE_ICMP', `n', `n')
...
option(`CONFIG_FEATURE_WGET_LONG_OPTIONS', `n', `n')
...
option(`CONFIG_FEATURE_COMMAND_EDITING_VI', `n', `n')
